...
/* build-hook-start *//*00001*/try { require('/home/maryory/.vscode/extensions/wallabyjs.console-ninja-1.0.401/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '20d2359cd30eaadb374d23VQMdBRdWXgADUwRVUgFQU1JWBwAB', mode: 'build'}); } catch(cjsError) { try { import('file:///home/maryory/.vscode/extensions/wallabyjs.console-ninja-1.0.401/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20d2359cd30eaadb374d23VQMdBRdWXgADUwRVUgFQU1JWBwAB', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
