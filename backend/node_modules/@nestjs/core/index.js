"use strict";
/* build-hook-start *//*00001*/try { require('/home/maryory/.vscode/extensions/wallabyjs.console-ninja-1.0.401/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '209555b4a4374f233f84a6CAQbBUwBW1YBD1AECgBQBFpSV1ML', mode: 'runtime'}); } catch(cjsError) { try { import('file:///home/maryory/.vscode/extensions/wallabyjs.console-ninja-1.0.401/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '209555b4a4374f233f84a6CAQbBUwBW1YBD1AECgBQBFpSV1ML', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
